...
<body>
    ...
    <div class="container">
        <div class="row  ">
            ...
            $sql = "SELECT * from notification WHERE ResPhone= '$phone'";
            ...
            if ($stmt->rowCount() > 0) {
                while ($row = $stmt->fetch()) { ?>
                    ...
                    <div class="toast" role="alert" aria-live="assertive" aria-atomic="true" id="enable">
    ...
    <script>
        ...
        function notify() {
            var toastHTMLElement = document.getElementById("enable");
